...
namespace ThirdPersonController
{
    ...
    public class AchievementSystem : MonoBehaviour
    {
        ...
        private void CreateDefaultAchievements()
        {
            ...
            {
                new AchievementData { achievementId = "KILL_10", title = "初出茅庐", description = "击杀10只敌人", targetValue = 10, rarity = AchievementRarity.Common, reward = new AchievementReward { exp = 50 } },
                new AchievementData { achievementId = "KILL_100", title = "猎杀者", description = "击杀100只敌人", targetValue = 100, rarity = AchievementRarity.Common, reward = new AchievementReward { exp = 100 } },
                new AchievementData { achievementId = "KILL_500", title = "深海屠夫", description = "击杀500只敌人", targetValue = 500, rarity = AchievementRarity.Rare, reward = new AchievementReward { exp = 200, pearls = 1 } },
                new AchievementData { achievementId = "KILL_1000", title = "毁灭者", description = "击杀1000只敌人", targetValue = 1000, rarity = AchievementRarity.Epic, reward = new AchievementReward { exp = 500, pearls = 2 } },
                ...
                new AchievementData { achievementId = "COMBO_100", title = "杀戮机器", description = "达成100连击", targetValue = 100, rarity = AchievementRarity.Epic, reward = new AchievementReward { exp = 300, pearls = 2 } },
                ...
                new AchievementData { achievementId = "CHAPTER_5", title = "深渊终结者", description = "通关第五章", targetValue = 5, rarity = AchievementRarity.Legendary, reward = new AchievementReward { exp = 1000, pearls = 5 } },
                
                new AchievementData { achievementId = "PEARL_10", title = "珍珠收藏家", description = "收集10颗珍珠", targetValue = 10, rarity = AchievementRarity.Rare, reward = new AchievementReward { exp = 100 } },
                ...
                new AchievementData { achievementId = "STARS_10", title = "星级收集者", description = "获得10颗星星", targetValue = 10, rarity = AchievementRarity.Rare, reward = new AchievementReward { exp = 100 } },
                new AchievementData { achievementId = "STARS_50", title = "全明星", description = "获得50颗星星", targetValue = 50, rarity = AchievementRarity.Epic, reward = new AchievementReward { exp = 500, pearls = 2 } },
            });
        }
