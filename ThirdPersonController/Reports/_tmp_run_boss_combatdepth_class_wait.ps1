...
$results = "C:\test\Shrimp\Assets\ThirdPersonController\Reports\PlayModeBatchResults_boss_combatdepth_round4_class.xml"
$log = "C:\test\Shrimp\Assets\ThirdPersonController\Reports\PlayModeBatchRunner_boss_combatdepth_round4_class.log"
...
$args = @(
  ...
  "-testResults", $results,
  "-testFilter", "ThirdPersonController.Tests.BossCombatDepthRegressionTests",
  "-logFile", $log
)
